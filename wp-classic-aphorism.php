<?php 
/*
Plugin Name: Classic Aphorism
Plugin URI: http://www.foo.com
Description: Example WordPress plugin. Shows classic random aphorism using 
Version 0.1
Author: Jenni Annala
...
//Include widget class of the plugin
include_once('wp-classic-aphorism-widget.php');
